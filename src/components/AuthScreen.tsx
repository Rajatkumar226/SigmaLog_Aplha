      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10">
        ...
        >
          <div className="bg-[#0f1421]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
            ...
            {/* Google Sign In — shown only on input stage */}
            {stage === "input" && (
              <div className="mb-5">
                <motion.button
                  ...
                  className="w-full px-6 py-3.5 bg-white text-gray-900 font-medium
                    rounded-lg transition-all flex items-center justify-center gap-3
